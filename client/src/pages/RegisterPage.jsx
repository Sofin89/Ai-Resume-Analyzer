              ...
              {password && (
                <div className="mt-3 space-y-2">
                  <div className="flex items-center text-sm">
                    <svg className={`w-4 h-4 mr-2 ${passwordRequirements.length ? 'text-green-500' : 'text-gray-300'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className={passwordRequirements.length ? 'text-gray-700' : 'text-gray-500'}>At least 6 characters</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <svg className={`w-4 h-4 mr-2 ${passwordRequirements.number ? 'text-green-500' : 'text-gray-300'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className={passwordRequirements.number ? 'text-gray-700' : 'text-gray-500'}>Contains a number</span>
                  </div>
                  <div className="flex items-center text-sm">
                    <svg className={`w-4 h-4 mr-2 ${passwordRequirements.specialChar ? 'text-green-500' : 'text-gray-300'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className={passwordRequirements.specialChar ? 'text-gray-700' : 'text-gray-500'}>Contains a special character</span>
                  </div>
                </div>
              )}
            </div>
